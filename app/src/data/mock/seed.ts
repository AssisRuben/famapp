...
// horario dispara lembrete push de segunda a sábado (ver src/lib/notifications.ts).
export const atividadesChecklistSeed: AtividadeChecklistSeed[] = [
  { id: 'chk-1', titulo: 'Conferir temperatura da geladeira de medicamentos', horario: '08:00', ativo: true },
  { id: 'chk-2', titulo: 'Organizar prateleira de produtos em promoção', horario: '09:30', ativo: true },
  { id: 'chk-3', titulo: 'Verificar validade dos produtos em destaque no balcão', horario: '14:00', ativo: true },
  { id: 'chk-4', titulo: 'Repor sacolas e materiais no caixa', horario: '17:00', ativo: true },
  { id: 'chk-5', titulo: 'Higienizar balcão de atendimento', horario: '18:30', ativo: true },
];
