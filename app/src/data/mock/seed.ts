...
export const catalogoProdutosSeed: ProdutoCatalogo[] = [
  { codigo: 2001, codigoBarras: '7891058109254', nome: 'Dipirona Gotas 10ml', categoria: 'Medicamentos', grupo: 'GENERICO', marca: 'EMS', precoVenda: 9.90, custoMedio: 5.20, estoqueAtual: 120 },
  ...
  { codigo: 2003, codigoBarras: '7891350037773', nome: 'Protetor Solar FPS70 120ml', categoria: 'Dermocosméticos', grupo: 'PERFUMARIA', marca: 'Sundown', precoVenda: 68.90, custoMedio: 38.00, estoqueAtual: 18 },
  { codigo: 2004, codigoBarras: '7500435123456', nome: 'Escova Dental Macia', categoria: 'Higiene Bucal', grupo: 'PERFUMARIA', marca: 'Oral-B', precoVenda: 12.50, custoMedio: 6.00, estoqueAtual: 200 },
  { codigo: 2005, codigoBarras: '7891024131253', nome: 'Fio Dental 50m', categoria: 'Higiene Bucal', grupo: 'PERFUMARIA', marca: 'Colgate', precoVenda: 8.90, custoMedio: 4.10, estoqueAtual: 150 },
  { codigo: 2006, codigoBarras: '7896098900014', nome: 'Álcool Gel 500ml', categoria: 'Higiene', grupo: 'PERFUMARIA', marca: 'Asfar', precoVenda: 14.90, custoMedio: 7.50, estoqueAtual: 90 },
  ...
  { codigo: 2010, codigoBarras: '7891350900718', nome: 'Sabonete Líquido Íntimo 200ml', categoria: 'Higiene', grupo: 'PERFUMARIA', marca: 'Nívea', precoVenda: 24.90, custoMedio: 13.00, estoqueAtual: 40 },
  { codigo: 2011, codigoBarras: '7896183301024', nome: 'Repelente Spray 100ml', categoria: 'Dermocosméticos', grupo: 'PERFUMARIA', marca: 'Exposis', precoVenda: 34.90, custoMedio: 19.00, estoqueAtual: 22 },
  { codigo: 2012, codigoBarras: '7891350031733', nome: 'Creme Hidratante Corporal 400ml', categoria: 'Dermocosméticos', grupo: 'PERFUMARIA', marca: 'Nívea', precoVenda: 32.90, custoMedio: 17.50, estoqueAtual: 55 },
  { codigo: 2013, codigoBarras: '7891010131207', nome: 'Absorvente Noturno 8un', categoria: 'Higiene', grupo: 'PERFUMARIA', marca: 'Sempre Livre', precoVenda: 11.90, custoMedio: 6.00, estoqueAtual: 130 },
  { codigo: 2014, codigoBarras: '7500435228756', nome: 'Shampoo Anticaspa 200ml', categoria: 'Cabelos', grupo: 'PERFUMARIA', marca: 'Head & Shoulders', precoVenda: 27.90, custoMedio: 15.00, estoqueAtual: 44 },
  { codigo: 2015, codigoBarras: '7500435228763', nome: 'Condicionador Reparador 200ml', categoria: 'Cabelos', grupo: 'PERFUMARIA', marca: 'Pantene', precoVenda: 26.90, custoMedio: 14.50, estoqueAtual: 38 },
  ...
  { codigo: 2017, codigoBarras: '7896422500019', nome: 'Ibuprofeno 400mg 20cp', categoria: 'Medicamentos', grupo: 'GENERICO', marca: 'Medley', precoVenda: 18.90, custoMedio: 10.50, estoqueAtual: 70 },
