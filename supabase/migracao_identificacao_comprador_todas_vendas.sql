-- Migração: compliance de identificação do comprador passa de "só
-- produto controlado" pra TODO tipo de venda, com filtro opcional pra
-- controlados na tela. Idempotente.
