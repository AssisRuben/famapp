-- ============================================================
-- Correção: conteudo_treinamento_balconista foi populada dia a dia
-- (todo dia) na primeira rodada de migracao_treinamento_balconista.sql.
-- Ajuste pedido: dia sim, dia não, a partir de 2026-08-10 (mesma data
-- que já estava sendo usada como início).
-- ============================================================

delete from conteudo_treinamento_balconista;
